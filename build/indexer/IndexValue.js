...
var IndexValue = /** @class */ (function () {
    ...
    IndexValue.prototype.put = function (id, object) {
        var batch = this.batch();
        batch.put(id, object);
        return batch.commit();
    };
    IndexValue.prototype.del = function (id, removes) {
        var batch = this.batch();
        batch.del(id, removes);
        return batch.commit();
    };
    IndexValue.prototype.batch = function () {
        return new IndexChain_1.IndexChain({
            property: this._prop,
            batch: this._store.batch()
        });
    };
    IndexValue.prototype.getMeta = function () {
        return { property: this._prop, type: "regular" };
    };
    IndexValue.prototype.startIndexing = function (col) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        i = 0;
                        return [4 /*yield*/, col.data()];
                    case 1:
                        data = _a.sent();
                        batch = this._store.batch();
                        data.docs.forEach(function (r) {
                            var id = r.id, rest = __rest(r, ["id"]);
    ...
    IndexValue.prototype.destroy = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
